                                ...
                                <div class="box-body table-responsive no-padding">
                                        ...
                                        <?php 
                                            $rec_limit = 10;
                                              ...
                                              $sql = "SELECT * from schoolselection_option4";
                                            ...
                                            if (isset($_POST['submit_table_search'])) {
                                                $sql = "SELECT * FROM schoolselection_option4 where Region LIKE '%$TableSearch%' OR District LIKE '%$TableSearch%' OR Institute_Code LIKE '%$TableSearch%' OR Institution LIKE '%$TableSearch%' OR Location LIKE '%$TableSearch%'";
                                            }else{
                                                $sql = "SELECT * from schoolselection_option4 limit $offset, $rec_limit";
                                            }
                                            $result = $conn->query($sql);
                                    ...
                                    <ul class="pagination pagination-sm no-margin pull-right">
                                     <?php 
                                        ...
                                        if (!isset($_POST['submit_table_search'])) {
                                            ...
                                            $last = $page - 2;
                                                echo "<li><a href = \"Fourth_choice.php?page=$last\">&laquo;</a></li>";
                                             }else if( $page == 0 and $left_rec>$rec_limit) {
                                                echo "<li><a href = \"Fourth_choice.php?page=$page\">&raquo;</a></li>";
                                             }else if( $page > 0) {
                                                $last = $page - 2;
                                                echo "<li><a href = \"Fourth_choice.php?page=$last\">&laquo;</a></li>";
                                                echo "<li><a href = \"Fourth_choice.php?page=$page\">&raquo;</a></li>";
