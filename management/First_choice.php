                                ...
                                <div class="box-body table-responsive no-padding">
                                        ...
                                        <?php 
                                            $rec_limit = 10;
                                              ...
                                              $sql = "SELECT * from schoolselection_option1";
                                            ...
                                            if (isset($_POST['submit_table_search'])) {
                                                $sql = "SELECT * FROM schoolselection_option1 where Region LIKE '%$TableSearch%' OR District LIKE '%$TableSearch%' OR School_Code LIKE '%$TableSearch%' OR School_Name LIKE '%$TableSearch%' OR Location LIKE '%$TableSearch%'";
                                            }else{
                                                $sql = "SELECT * from schoolselection_option1 limit $offset, $rec_limit";
                                            }
                                            $result = $conn->query($sql);
                                      ...
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                                ...
                                                <?php
                                                    $sql_modal = "SELECT * from schoolselection_option1 where ID = $ID";
                                                    $results = $conn->query($sql_modal);
                                                    if ($results->num_rows > 0) {
                                                        ...
                                                        while ($row1 = $results->fetch_assoc()) {
                                                                $arr = [];
                                                                $arr['1'] = $row1['Status_Day'];
                                                                $arr['2'] = $row1['Status_Boarding'];
                                                                $arr['3'] = $row1['Status_Hostel'];
                                                                $dataArr = [];
                                                                $dataArr['101'] = $row1['Course_101'];
                                                                $dataArr['201'] = $row1['Course_201'];
                                                                $dataArr['301'] = $row1['Course_301'];
                                                                $dataArr['401'] = $row1['Course_401'];
                                                                $dataArr['402'] = $row1['Course_402'];
                                                                $dataArr['501'] = $row1['Course_501'];
                                                                $dataArr['502'] = $row1['Course_502'];
                                                            echo "
                                                                <tr>
                                                                    <td>".$row1['Gender']."</td>
                                                                    <td>".json_encode($dataArr)."</td>
                                                                    <td>".json_encode($arr)."</td>
                                                                </tr>
                                                            ";
                                                        }
                                                    }
                                    ...
                                    <ul class="pagination pagination-sm no-margin pull-right">
                                     <?php 
                                        ...
                                        if (!isset($_POST['submit_table_search'])) {
                                            ...
                                            $last = $page - 2;
                                                echo "<li><a href = \"First_choice.php?page=$last\">&laquo;</a></li>";
                                             }else if( $page == 0 and $left_rec>$rec_limit) {
                                                echo "<li><a href = \"First_choice.php?page=$page\">&raquo;</a></li>";
                                             }else if( $page > 0) {
                                                $last = $page - 2;
                                                echo "<li><a href = \"First_choice.php?page=$last\">&laquo;</a></li>";
                                                echo "<li><a href = \"First_choice.php?page=$page\">&raquo;</a></li>";
