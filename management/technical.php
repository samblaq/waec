                                ...
                                <div class="box-body table-responsive no-padding">
                                        ...
                                        <?php 
                                            $rec_limit = 10;
                                              ...
                                              $sql = "SELECT * from student where programme = 'Technical'";
                                            ...
                                            if (isset($_POST['submit_table_search'])) {
                                                ...
                                                $sql = "SELECT * from student where programme = 'Technical' limit $offset, $rec_limit";
                                            }
                                            $result = $conn->query($sql);
                                    ...
                                    <ul class="pagination pagination-sm no-margin pull-right">
                                     <?php 
                                        ...
                                        if (!isset($_POST['submit_table_search'])) {
                                            ...
                                            $last = $page - 2;
                                                echo "<li><a href = \"technical.php?page=$last\">&laquo;</a></li>";
                                             }else if( $page == 0 and $left_rec>$rec_limit) {
                                                echo "<li><a href = \"technical.php?page=$page\">&raquo;</a></li>";
                                             }else if( $page > 0) {
                                                $last = $page - 2;
                                                echo "<li><a href = \"technical.php?page=$last\">&laquo;</a></li>";
                                                echo "<li><a href = \"technical.php?page=$page\">&raquo;</a></li>";
