<?php
	...
	include("databaseconnection.php");
		$sql_programme = "SELECT * from schoolselection_option2 WHERE ID = $Id";
		...
		$sql_accomodation = "SELECT * from schoolselection_option2 where ID = $Id";
		...
		$sql_region = "SELECT * from schoolselection_option2 where ID = $Id";
		...
		$sql_schoolCode = "SELECT * from schoolselection_option2 where ID = $Id";
