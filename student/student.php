<?php
    ...
    if (isset($_POST['Finish'])) {
        ...
        $studentimage = sanitize($_POST['studentimage']);

        for ($i=1; $i < 1000; $i++) { 
            $index = $_SESSION['School_Code'] . '00' . $i;
        }



            $sql_student_details = "INSERT INTO student (image, index_num,surname,othername,gender,DOB,address,title,surname1,other,relation,occupation,phone,email,adds,first,region,code,programme,
                ...
                agree) values ('$studentimage','$index','$surname','$othername','$gender','$DOB','$address','$title','$surname1','$other','$relation',
            ...
            $UploadImageSuccess = "Student Registered successfully";
    }
?>
<!DOCTYPE html>
<html>
        ...
        <script type="text/javascript">
            ...
            function onUploadSuccess(){
                ...
                if (responseData && responseData.success && responseData.fileName) {
                    ...
                    alert("Passport picture saved successfully");
                    var studentImage = document.getElementById('student-image');
                    studentImage.value = "studentImages/" + fileName;
        ...
        <div id="wrapper">
            ...
            <div class="left side-menu">
                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div class="user-box">
                        <div class="user-img">
                            <img src="assets/images/users/avatar-1.jpg" alt="user-img" title="Mat Helme" class="rounded-square img-fluid">
                        </div>
                        <h5><a href="#"><?php echo $sch_name; ?></a> </h5>
                        <p class="text-muted"><?php echo $sch_code ?></p>
                    </div>
                                            ...
                                            <div>
                                                ...
                                                <section>
                                                    ...
                                                    <div class="form-group clearfix">
                                                        ...
                                                        <div class="col-lg-2">
                                                            ...
                                                            <input type="button" value="Upload" name ="save" onclick="uploadCapturedImage();" class="btn btn-primary form-control" />
                                                        </div>
                                                    </div> 
                                                    ...
                                                    <div class="form-group clearfix" style="display:none">
                                                        ...
                                                        <div class="col-lg-2">
                                                            <label class="control-label " for="address">Image<b style="color:red">*</b></label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input name="studentimage" id="student-image" class="form-control"/>
                                                        </div>
                                                    </div>
                                                ...
                                                <section>
                                                    ...
                                                    <div class="form-group clearfix">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" name="code_2" id ='code_2' class="form-control" readonly="readonly" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group clearfix">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" name="code_3" id = "code_3" class="form-control" readonly="readonly" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group clearfix">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" name="code_4" id = "code_4" class="form-control" readonly="readonly" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group clearfix">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="checkbox checkbox-primary">
                                                                ...
                                                                <p><a href="unknown.com"> Terms & Conditions</a></p>
                                                            </div>
                                                        </div>
                                                    </div>
            ...
            surname: {
                validators: {   
                    ...
                    stringLength: {
                        min: 3,
                        max: 20,
                        message: 'The surname must be more than 3 and less than 20 characters long'
                    },
                    regexp: {
                        regexp: /^[a-zA-Z\s]+$/,
            ...
            otherNames: {
                validators: {
                    ...
                    stringLength: {
                        min: 3,
                        max: 20,
                        message: 'The othername must be more than 3 and less than 20 characters long'
                    },
                    regexp: {
                        regexp: /^[a-zA-Z\s]+$/,
